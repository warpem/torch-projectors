 ...
 *
 * This header declares back-projection operations that accumulate 3D projections
 ...
 * - Full 3D rotation (not limited to central slice theorem)
 */
...
/**
 * Forward pass: Back-projection from 3D projections to 3D reconstructions
 *
 ...
 *
 * @param projections: Input 3D projections (B, P, D, H, W/2+1) in FFTW format
 * @param weights: Optional weights (B, P, D, H, W/2+1) for CTF^2 or similar applications
 * @param rotations: 3x3 rotation matrices (B_rot, P, 3, 3)
 * @param shifts: Optional 3D shifts (B_shift, P, 3)
...
/**
 * Backward pass: Gradient computation for 3D->3D back-projection
 *
 ...
 * @param projections: Original 3D projections (B, P, D, H, W/2+1)
 * @param weights: Optional weights (B, P, D, H, W/2+1)
 * @param rotations: 3x3 rotation matrices (B_rot, P, 3, 3)
 * @param shifts: Optional 3D shifts (B_shift, P, 3)
 * @param interpolation: "linear" or "cubic"
