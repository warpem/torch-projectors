...
__global__ void project_2d_forw_kernel(
...
__global__ void project_2d_back_kernel(
...
at::Tensor project_2d_forw_cuda(
    ...
    if (reconstruction.scalar_type() == at::kComplexDouble) {
        ...
        auto result_cpu = project_2d_forw_cpu(
    ...
    project_2d_forw_kernel<<<gridDim, blockDim, 0, stream>>>(
...
std::tuple<at::Tensor, at::Tensor, at::Tensor> project_2d_back_cuda(
    ...
    if (grad_projections.scalar_type() == at::kComplexDouble) {
        ...
        auto [grad_reconstruction_cpu, grad_rotations_cpu, grad_shifts_cpu] = project_2d_back_cpu(
    ...
    project_2d_back_kernel<<<gridDim, blockDim, 0, stream>>>(
