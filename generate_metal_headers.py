...
def generate_header(output_path, csrc_mps_path):
    ...
    utilities_content = read_metal_file(os.path.join(csrc_mps_path, "2d", "utilities_2d.metal"))
    forward_content = read_metal_file(os.path.join(csrc_mps_path, "2d", "forward_2d.metal"))
    backward_content = read_metal_file(os.path.join(csrc_mps_path, "2d", "backward_2d.metal"))
...
// Generated from utilities_2d.metal, forward_2d.metal, and backward_2d.metal
