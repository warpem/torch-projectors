...
python paper/results/oversampling_table_generator.py paper/results/data/oversampling_benchmark paper/results/tables/oversampling-table.tex --caption "Throughput depending on interpolation and padding strategy, \$10^3\$ projections/second"